...
namespace BlockBrawl
{
    class Settings
    {
        ...
        {
            if (CurrentMenuChoice == 1) { settingsChoiceSwitcher = SettingsChoice.configureGamePad; }
            else if (CurrentMenuChoice == 2) { settingsChoiceSwitcher = SettingsChoice.resetPreConfig; }
            else if (CurrentMenuChoice == 3) { settingsChoiceSwitcher = SettingsChoice.viewSteerings; }
        }
        ...
        public void Draw(SpriteBatch sb)
        {
            ...
            sb.DrawString(FontManager.MenuText, "To go menu? Use ESC / Select", new Vector2(0,
